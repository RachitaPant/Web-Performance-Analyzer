      ...
      <div className="bg-white p-8 rounded-lg shadow-md mt-6 w-full max-w-3xl text-center">
        ...
        <ul className="mt-4 text-left space-y-1">
          <li className="text-gray-700 flex items-center gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 shrink-0" /> How to analyze my website?
          </li>
          <li className="text-gray-700 flex items-center gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 shrink-0" /> Understanding the performance metrics
          </li>
          <li className="text-gray-700 flex items-center gap-2">
            <CheckCircle className="h-4 w-4 text-green-600 shrink-0" /> Improving website speed
          </li>
        </ul>
